...
%	\begin{cajita}
	...
	\textbf{Dientes rectos}\\
			\includegraphics[height=0.18\textwidth]{engranaje-recto}\\
			...
			% Entre centro:\\\vspace*{0.1cm}
			% $ec=\dfrac{dp_1+dp_2}{2}=\dfrac{M z_1+ M z_2}{2}=\frac{M}{2}(z_1+z_2)$\\\vspace*{0.2cm}
...
%	\end{cajita}
	...
	\end{tabular}\\
		...
		% \begin{tabular}{r l}
		% 	\multirow[c]{5}{*}{\includegraphics[width=0.2\textwidth]{engranaje-heli.jpg}} 
		% 	&\\
		% 	&\\
		% 	&$M_c=\dfrac{t_c}{\pi}$\\	
		...
		\begin{multicols}{2}
			\includegraphics[width=0.2\textwidth]{engranaje-heli.jpg}\\
			$\left\{\begin{array}{l}
				M_c=\dfrac{t_c}{\pi}\\
				t_n\approx t_c Cos(\phi)\\
			\end{array} \right.$\\
	...
	\begin{multicols}{2}
		...
		\includegraphics[width=5.3cm]{engranaje-heli2.jpg}\\
		\vfill\columnbreak
		\vspace*{0.8cm}
	...
	\newpage
		...
		\begin{multicols}{2}
			\textbf{\textit{Descomposición de fuerzas}}\\
			\includegraphics[width=4.5cm]{engranaje-concurrentes.jpg}\\
			\vfill\columnbreak
			\vspace*{0.2cm}
			$P_t=71620\dfrac{N}{n\frac{D_p}{2}}$\\
			$F=P_t~tan(\alpha)$\\
			$F_x=F~cos(\beta_2)$\\
			$F_y=F~cos(\beta_1)$\\
			% $F_x=F~cos(\beta_2)=P_t~tan(\alpha)~cos(\beta_2)$\\
			% $F_y=F~cos(\beta_1)=P_t~tan(\alpha)~cos(\beta_1)$\\
		\end{multicols}
	\vspace*{0.2cm}
	\vfill\columnbreak
