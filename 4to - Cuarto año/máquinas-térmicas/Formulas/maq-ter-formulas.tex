...
\begin{document}
	...
	\end{cajita}
		...
		Buscar por tabla: \boxed{g_{humo}= g_{CO_2} + g_{H_2O} + g_{S_2O} + g_{N_2} + g_w}\\ \vspace{.2cm}
		
		\boxed{g_{humo} = (3.67\ C + 9\ Hd +2\ S) + 3.35\ (2.67\ C + 8\ Hd + S) + g_{agua}}\\\vspace{.2cm}
		
		\boxed{V_{humo} = 1.897\ C + 11.2\ Hd +0.7\ S + 3.76\ (1.867\ C + 5.6\ Hd +0.7\ S) + 1.24\ g_{agua}}
	...
	\begin{cajita}
		...
		\begin{multicols}{2}
				...
				\boxed{g_{sec} = C\ g_{sec/C} = C\ \left(\dfrac{\sum \mu_i\ r_i}{\mu_{C}\ (r_{CO_2} + r_{CO})}\right)}\\[.2cm]
		...
		\begin{multicols}{2}
			...
			\end{gather*}
			\boxed{g'_{C} = \sum_{i=1}^{n} \mu_{C}~r_{iC}}
